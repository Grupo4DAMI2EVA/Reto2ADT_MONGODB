...
/**
 * Controller class for the User Registration Window interface. This class
 * handles the complete user registration process, including form validation,
 * data collection, and user account creation. It provides a comprehensive
 * interface for new users to create accounts with proper validation for all
 * required fields.
 *
...
public class SignUpWindowController implements Initializable {
    ...
    /**
     * Sets the main controller for this registration window controller. This
     * method establishes the connection to the main application controller that
     * handles business logic and user registration operations.
     *
     * @param controller the main application controller that manages business
     ...
     * This method validates all input fields, collects user data, creates a new
     * User object, and attempts to register the user through the main
     * controller. Upon successful registration, the user is automatically
     * logged in and redirected to the user window.
     *
     * The method performs comprehensive validation including field completeness
     * checks, email format validation, telephone number format validation,
     * password strength requirements, and credit card number validation.
     *
     */
    @FXML
    private void handleSignUp() {
        ...
        User user = new User(email, username, password, name, lastname, telephone, gender, card);
        ...
        try {
            ...
            if (registeredUser != null) {
                // ¡¡IMPORTANTE!! Guarda el usuario en LoggedProfile
                LoggedProfile.getInstance().setProfile(registeredUser);

                ShowAlert.showAlert("Success", "User registered successfully.", Alert.AlertType.INFORMATION);

                // Ahora navega a UserWindow
                ...
                userController.setController(this.controller);  // Esto es probablemente la línea 156
    ...
    /**
     * Navigates back to the login window. This method loads the login interface
     * and transitions the current window to display the login screen, typically
     * used when the user chooses to return to login.
     *
     */
    @FXML
    ...
    /**
     * Validates all input fields in the registration form. This method checks
     * each required field for proper formatting, completeness, and content
     * according to business rules, applying visual error styling to invalid
     * fields.
     *
     * @return true if all fields pass validation, false if any validation rule
     * is violated
     */
    ...
    /**
     * Resets the visual style of all input fields to their normal state. This
     * method removes any error styling applied during validation and restores
     * the default appearance of all form fields.
     */
    ...
    /**
     * Validates an email address format. This method checks if the provided
     * email string matches the standard email format pattern including local
     * part, @ symbol, domain, and top-level domain.
     *
     * @param email the email address string to validate
     * @return true if the email address matches the required format, false
     * otherwise
     */
    ...
    /**
     * Validates a telephone number format. This method checks if the provided
     * telephone string contains exactly 9 numeric digits.
     *
     * @param telephone the telephone number string to validate
     * @return true if the telephone number matches the required format, false
     * otherwise
     */
    ...
    /**
     * Validates a password according to security requirements. This method
     * checks if the password meets the minimum security standards including
     * length, character diversity, and complexity. The password must contain at
     * least 8 characters, including one uppercase letter, one lowercase letter,
     * and one number.
     *
     * @param password the password string to validate
     * @return true if the password meets all security requirements, false
     * otherwise
     */
     ...
     * characters only and enforces a maximum length of 9 digits for telephone
     * numbers.
     */
    ...
    /**
     * Configures the credit card number text fields with input validation and
     * navigation. This method sets up text change listeners for all four card
     * number segments that enforce numeric-only input, limit each segment to 4
     * characters, and provide automatic navigation between segments when filled
     * or emptied.
     */
     ...
     * and configures the input validation for telephone and credit card number
     * fields.
     *
